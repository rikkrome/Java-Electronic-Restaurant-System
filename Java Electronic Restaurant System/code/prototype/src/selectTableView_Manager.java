...
public class selectTableView_Manager implements ActionListener{
	...
	public selectTableView_Manager(){
		downloadStatus();
		selectTableView_Manager();
	...
	public void actionPerformed(ActionEvent ae){
	    ...
	    if(button == btnTable1){
	    	managerView managerClass = new managerView("1");
    		JPanel customerView = managerClass.returnManagerView();
    		
	    	contentPane.removeAll();
    	    contentPane.add(customerView);
    	    
	    }else if(button == btnTable2){
	    	managerView managerClass = new managerView("2");
    		JPanel customerView = managerClass.returnManagerView();
	    	...
	    	managerView managerClass = new managerView("3");
    		JPanel customerView = managerClass.returnManagerView();
	    	...
	    	managerView managerClass = new managerView("4");
    		JPanel customerView = managerClass.returnManagerView();
	    	...
	    	managerView managerClass = new managerView("5");
    		JPanel customerView = managerClass.returnManagerView();
	    	...
	    	managerView managerClass = new managerView("6");
    		JPanel customerView = managerClass.returnManagerView();
    ...
    public JPanel returnselectTableView_Manager(){    	
    	
		return selectTableView_WaitStaff;
    }
	
	public void selectTableView_Manager(){
